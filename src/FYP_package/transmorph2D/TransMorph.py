...
import numpy as np
import FYP_package.transmorph2D.configs_TransMorph as configs
...
class SpatialTransformer(nn.Module):
    ...
    def forward(self, x, flo):
        ...
        output = nnf.grid_sample(x.float(), vgrid.float(), mode = self.mode ,padding_mode = 'zeros', align_corners=True)
